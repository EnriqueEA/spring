										...
										<tbody>
												...
												<c:forEach items="${concursos}" var="x">
													<tr>
														<td>${x.idConcurso}</td>
														<td>${x.nombre}</td>
														<td><fmt:formatDate value="${x.fechaInicio}" pattern="yyyy-MM-dd"/> </td>
														<td><fmt:formatDate value="${x.fechaFin}" pattern="yyyy-MM-dd"/></td>
														<td>${x.estado}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idConcurso}','${x.nombre}','<fmt:formatDate value="${x.fechaInicio}" pattern="yyyy-MM-dd"/>','<fmt:formatDate value="${x.fechaFin}" pattern="yyyy-MM-dd"/>','${x.estado}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
  	 ...
  	 <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaConcurso" class="form-horizontal"     method="post">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="registraActualizaConcurso" class="form-horizontal"     method="post">
							<div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
